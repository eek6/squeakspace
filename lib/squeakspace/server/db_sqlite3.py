...
def make_db(c, total_quota):
    ...
    c.execute('''CREATE INDEX key_hash_index ON keys(public_key_hash)''')
    ...
    c.execute('''CREATE INDEX user_id_index ON users(user_id)''')
    ...
    c.execute('''CREATE INDEX message_access_index ON message_access(user_id)''')
    ...
    c.execute('''CREATE INDEX message_time_index ON messages(to_user, timestamp)''')
    c.execute('''CREATE INDEX message_id_index ON messages(to_user, message_id)''')
    ...
    c.execute('''CREATE INDEX group_id_index ON groups(owner_id, group_id)''')
    ...
    c.execute('''CREATE INDEX group_post_time_index ON group_posts(owner_id, group_id, timestamp)''')
    c.execute('''CREATE INDEX group_post_id_index ON group_posts(owner_id, group_id, post_id)''')
