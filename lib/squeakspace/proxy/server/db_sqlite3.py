...
import squeakspace.common.session_id as sid
...
def make_db(c):
    ...
    c.execute('''CREATE INDEX user_password_index ON user_passwords(user_id)''')
    ...
    c.execute('''CREATE INDEX public_key_index ON public_keys(user_id, public_key_hash)''')
    ...
    c.execute('''CREATE INDEX private_key_index ON private_keys(user_id, public_key_hash)''')
    ...
    c.execute('''CREATE INDEX user_key_index ON user_keys(user_id, node_name, public_key_hash)''')
    ...
    c.execute('''CREATE INDEX other_user_key_index ON other_user_keys(local_user_id, user_id, node_name, public_key_hash)''')
    ...
    c.execute('''CREATE INDEX group_key_index ON group_keys(local_user_id, owner_id, group_id, node_name, key_use)''')
    ...
    c.execute('''CREATE INDEX session_index ON sessions(session_id, user_id)''')
    c.execute('''CREATE INDEX session_expire_index ON sessions(expire_time)''')
    ...
    c.execute('''CREATE INDEX group_access_index ON group_access(user_id, group_id, owner_id, node_name, use)''')
    ...
    c.execute('''CREATE INDEX message_access_index ON message_access(user_id, to_user, node_name, from_user_key_hash)''')
    ...
    c.execute('''CREATE INDEX default_message_access_index ON default_message_access(user_id, to_user, node_name)''')
